...
import com.cosmos.camera.ICamera.ICameraNumber
...
//            this.isFront = isFront
    ...
    private fun pveviewInner() {
        ...
        currentCamera?.let {
            ...
            for (supportedFocusMode in supportedFocusModes) {
                if (Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE == supportedFocusMode) {
                    parameters.focusMode = supportedFocusMode
                    it.parameters = parameters
                    return
                }
            }
            LogUtil.v(TAG, "not support FOCUS_MODE_CONTINUOUS_PICTURE!!!")
        }
